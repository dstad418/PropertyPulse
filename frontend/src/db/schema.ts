// Database schema for PropertyPulse Demo Project.
// These types are used in the supabase library to make accessing data from the db a little easier
// or at the very least easy to read. 
